...
class _IdentityMet(torch.nn.Module):
    ...
    def forward(self, x_met, x_dem):
        return x_met


def test_hourly_descent_then_min_selects_minimum():
...
class _RandomHourlyDataset(Dataset):
    """Nuits synthétiques horaires : x_met (T, C, H, W) + stations sparse."""

    def __init__(self, n=6, T=4):
